...
function helpForPhotoStep1Page(req, res) {
  const page = 'photo-help/help-for-photo-1';
  res.render(page, {
    route: getRoute(req),
...
function helpForPhotoStep2Page(req, res) {
  const page = 'photo-help/help-for-photo-2';
  res.render(page, {
    route: getRoute(req),
    sessionId: req.cookies.sessionId,
    timeStamp: Date.now(),
...
function helpForPhotoStep3Page(req, res) {
  const page = 'photo-help/help-for-photo-3';
  res.render(page, {
    route: getRoute(req),
    sessionId: req.cookies.sessionId,
    timeStamp: Date.now(),
...
function helpForPhotoStep4Page(req, res) {
  const page = 'photo-help/help-for-photo-4';
  res.render(page, {
    route: getRoute(req),
    sessionId: req.cookies.sessionId,
    timeStamp: Date.now(),
...
function helpForPhotoStep5Page(req, res) {
  const page = 'photo-help/help-for-photo-5';
  res.render(page, {
    route: getRoute(req),
    sessionId: req.cookies.sessionId,
    timeStamp: Date.now(),
